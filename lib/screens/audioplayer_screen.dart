...
class _AudioplayerScreenState extends State<AudioplayerScreen> {
  ...
  void didChangeDependencies() {
    ...
    // Accept all audio files, not just mp3
    ...
    // Optional: Safety check if the selected audio is not in the list
    if (!_mp3Files.contains(audioPath) && _mp3Files.isNotEmpty) {
      audioPath = _mp3Files.first;
