...
class _AudioplayerScreenState extends State<AudioplayerScreen> {
  ...
  void initState() {
    super.initState();
    _audioPlayer = AudioPlayer();
    _audioPlayer.setReleaseMode(ReleaseMode.release); // Ensure auto-next works
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    ...
                    image: albumImageBytes != null
                        ? MemoryImage(albumImageBytes!)
                        : const AssetImage('assets/Song Cover Art 1.png') as ImageProvider,
                  ),
                ),
              ),
              Text(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Up next',
                      style: GoogleFonts.bakbakOne(color: Colors.white, fontSize: 20.sp),
                    ),
                    SizedBox(height: 10.h),
                    Text(
                      _mp3Files.isNotEmpty
                          ? _mp3Files[audioIndex < _mp3Files.length - 1
                                  ? audioIndex + 1
                                  : 0]
                              .split('/')
              ...
              Row(
                ...
                children: [
                  IconButton(
                    onPressed: _playPrevious,
                    icon: Icon(Icons.skip_previous_rounded, size: 30.r, color: Colors.white),
                  ),
                  IconButton(
                    onPressed: _playPause,
                    icon: Icon(
                  ...
                  IconButton(
                    onPressed: _playNext,
                    icon: Icon(Icons.skip_next_rounded, color: Colors.white, size: 30.r),
                  ),
                  IconButton(
                    onPressed: () {
                      setState(() => _isLooping = !_isLooping);
